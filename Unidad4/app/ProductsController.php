...
if(isset($_POST['action'])){
    if(isset($_POST['global_token']) && $_POST['global_token'] == $_SESSION['global_token']){
        switch ($_POST['action']) {
            ...
            break;
            case 'delete':
                echo "<script>console.log('Entro al delete: ' );</script>";
                $productController = new ProductsController();
...
class ProductsController {
    ...
    public function createProduct($name, $slug, $description, $features, $brand_id) {
        ...
        if( isset($response->code) &&  $response->code > 0) {
            header ("Location:".BASE_PATH."casa?success=true");
        } else {
            header ("Location:".BASE_PATH."casa?error=true");
        }
    }
	...
	{
        echo "<script>console.log('Entro al delete: " . $id . "' );</script>";
        $curl = curl_init();
        curl_setopt_array($curl, array(
		...
		if ( isset($response->code) && $response->code > 0) {
			...
			header ("Location:".BASE_PATH."casa");
		}else{ 
