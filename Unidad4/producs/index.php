                                ...
                                <img src="<?= $producto->cover ?>" class="card-img-top img-fluid" alt="...">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <a  onclick="remove(<?= $producto->id ?>)" class="btn btn-danger col-6" href="#">Eliminar</a>
                                            <a href="verMas?slug=<?= $producto->slug ?>" class="btn btn-info col-12">Detalles</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function remove (id) {
            ...
            if (willDelete) {
                ...
                axios.post('<?= BASE_PATH?>products',bodyFromData)
